...
# Size of sectors used to ease block loading.from __future__ import division
...
def save(win):
	...
	saveFile=open('testlevel.txt','w+')
	for loc in win.model.world.keys():
		if loc[1]>-2 and win.model.world[loc]!=STONE:
			if win.model.world[loc]==BRICK:
				i=0
				for _ in saveFile:
					i+1
				saveFile.seek(0,i)
